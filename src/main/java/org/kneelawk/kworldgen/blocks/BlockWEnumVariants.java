...
public abstract class BlockWEnumVariants extends KWGBlock
	...
	public BlockWEnumVariants(Material blockMaterialIn,
			MapColor blockMapColorIn) {
		super(blockMaterialIn, blockMapColorIn);
	}

	public BlockWEnumVariants(Material materialIn) {
		super(materialIn);
	}
